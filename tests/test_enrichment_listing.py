...
def test_a_trailing_blank_in_the_first_name_does_not_double_the_space() -> None:
    # Seen on a live listing: "Talissa " + "Blajan" became "Talissa  Blajan" on the
    # card, in the salutation and inside the LinkedIn search.
    _, person, _ = derive_contact({"firstName": "Talissa ", "lastName": "Blajan"}, "")
    assert person == "Talissa Blajan"
